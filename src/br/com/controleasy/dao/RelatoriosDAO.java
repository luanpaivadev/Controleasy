...
public class RelatoriosDAO {
    ...
    public static void gerarRelatorioPorPeriodo(Date dataInicial, Date dataFinal, String relatorio, String image) {
    ...
    public static void gerarRelatorioPorPeriodoPorSituacao(Date dataInicial, Date dataFinal, String situacao, String relatorio, String image) {
        JasperPrint jasperPrint = null;
        @SuppressWarnings("UnusedAssignment")
        JasperReport jasperReport = null;
        InputStream inputStream = Thread.currentThread().getClass().getResourceAsStream("/br/com/controleasy/relatorios/" + relatorio + ".jrxml");
        ...
        JasperViewer viewer = new JasperViewer(jasperPrint, false);
        viewer.setTitle("RELATÓRIO - DESPESAS POR PERÍODO POR SITUACÃO");
        viewer.setVisible(true);
        viewer.toFront();
    }
